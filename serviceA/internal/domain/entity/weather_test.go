...
func TestNewWeather_PositiveTemperature(t *testing.T) {
	weather := NewWeather("São Paulo", 25.0, 77.0, 298.0)
...
func TestNewWeather_ZeroCelsius(t *testing.T) {
	weather := NewWeather("Polo Sul", 0.0, 32.0, 273.0)
...
func TestNewWeather_BoilingPoint(t *testing.T) {
	weather := NewWeather("Deserto", 100.0, 212.0, 373.0)
...
func TestNewWeather_NegativeTemperature(t *testing.T) {
	weather := NewWeather("Antártida", -40.0, -40.0, 233.0)
...
func TestNewWeather_AbsoluteZero(t *testing.T) {
	weather := NewWeather("Espaço", -273.0, -459.4, 0.0)
...
func TestNewWeather_VeryHotTemperature(t *testing.T) {
	weather := NewWeather("Vulcão", 1000.0, 1832.0, 1273.0)
...
func TestNewWeather_DecimalTemperature(t *testing.T) {
	weather := NewWeather("Rio de Janeiro", 28.7, 83.66, 301.7)
...
// TestCalcFahrenheit_Accuracy foi removido porque a lógica de cálculo foi removida da entidade.
/*
func TestCalcFahrenheit_Accuracy(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		// weather.calcFahrenheit() // This method is removed
...
// TestCalcKelvin_Accuracy foi removido porque a lógica de cálculo foi removida da entidade.
/*
func TestCalcKelvin_Accuracy(t *testing.T) {
	...
	for _, tc := range testCases {
		weather := &Weather{Temp_c: tc.celsius}
		// weather.calcKelvin() // This method is removed
...
func TestNewWeather_LocationPreserved(t *testing.T) {
	...
	for _, city := range locations {
		weather := NewWeather(city, 20.0, 68.0, 293.0)
...
func TestNewWeather_ReturnsNonNilPointer(t *testing.T) {
	weather := NewWeather("Test", 15.0, 59.0, 288.0)
